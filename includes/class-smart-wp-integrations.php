...
class Smart_Wp_Integrations {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/accounting/erply/class-erply-create-invoices.php';
		if ( get_option( 'swi_erply_enable' ) === 'yes' ) {
		...
		add_action( 'woocommerce_shipping_init', function() {
			...
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/shipping/omniva/class-omniva-shipping.php';
		} );
		add_filter( 'woocommerce_shipping_methods', function( $methods ) {
			...
			$methods['swi_omniva']              = 'SWI_Omniva_Shipping';
			return $methods;
		} );
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/shipping/omniva/class-omniva-admin.php';
		new SWI_Omniva_Admin();
